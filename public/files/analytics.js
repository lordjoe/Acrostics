...
*/
    ...
    var B = window, C = window.history, D = document, E = navigator, F = function (a, b) {
        D.addEventListener ? D.addEventListener(a, b, !1) : D.attachEvent && D.attachEvent("on" + a, b)
    };
    var G = /:[0-9]+$/, J = function (a, b) {
    ...
    var L;
    var N = function () {
        var a = ca, b = da, c = M(), d = function (h) {
            ...
            if (void 0 !== d && d === d && null !== d && "[object Object]" !== d.toString()) {
                ...
                for (var h = [], g = 0; g < d.length; g += 3) {
                    var k = g + 1 < d.length, m = g + 2 < d.length, l = d.charCodeAt(g),
                        r = k ? d.charCodeAt(g + 1) : 0, x = m ? d.charCodeAt(g + 2) : 0, ha = l >> 2;
                    l = (l & 3) << 4 | r >> 4;
                    r = (r & 15) << 2 | x >> 6;
                    x &= 63;
                    m || (x = 64, k || (r = 64));
    ...
    function ia(a) {
        return function (b) {
            var c = K(B.location.href), d = c.search.replace("?", "");
            a:{
                var e = d.split("&");
...
(function () {
    ...
    function af(a) {
        ...
        Aa = /^https?:\/\/[\w\-.]+\.google.com(:\d+)?\/optimize\/opt-launch\.html\?.*$/, nf = 0, t = function (a) {
            function b(d, e) {
                e && (c += "&" + d + "=" + K(e))
            }
