(function () {
    var g = void 0, h = true, k = null, m = false, n, o = this;
    ...
    function ja(a) {
        ...
        for (var b = [1518500249, 1859775393, 2400959708, 3395469782], c = 1732584193, d = 4023233417, e = 2562383102, f = 271733878, i = 3285377520, j = [], l, s, w, D, F, T = Math.ceil((a.length / 4 + 2) / 16), P = [T], y = 0, t; y < T; y++) {
            P[y] = [];
        ...
        P[a][15] = y & 4294967295;
        for (y = 0; y < T; y++) {
            for (t = 0; t < 16; t++) j[t] = P[y][t];
            for (t = 16; t < 80; t++) j[t] = (j[t - 3] ^ j[t - 8] ^ j[t - 14] ^ j[t - 16]) << 1 | (j[t - 3] ^ j[t - 8] ^ j[t - 14] ^ j[t - 16]) >>> 31;
            a = c;
            l = d;
            s = e;
            w = f;
            D = i;
            for (t = 0; t < 80; t++) F = Math.floor(t / 20), F = (a << 5 | a >>> 27) + (F == 0 ? l & s ^ ~l & w : F == 1 ? l ^ s ^ w : F == 2 ? l & s ^ l & w ^ s & w : l ^ s ^ w) + D + b[F] + j[t] & 4294967295, D = w, w = s, s = l << 30 | l >>> 2, l = a, a = F;
            c = c + a & 4294967295;
            d = d + l & 4294967295;
            e = e + s & 4294967295;
            f = f + w & 4294967295;
    ...
    function ka(a) {
        var b = o.navigator, c = o.window.screen,
    ...
    function xa(a) {
        var b = a.match(/\?(.*)$/ig) ? a.match(/\?(.*)$/ig)[0].slice(1).replace(/#(.*)?/ig, "").split("&") : [],
            ...
            a = a.match(/[#|\?](.*)?/ig) ? a.slice(0, a.search(/[#|\?](.*)?/ig)) : a, b = ya(b, function (a) {
    ...
    function Ha(a, b) {
        ...
        for (var j, l, s, d = 1; d <= e; d++) for (f = 1; f <= i; f++) j = d - 1, l = f - 1, s = c[j][l], b.charAt(j) == a.charAt(l) ? c[d][f] = s : (l = c[d][l] + 1, j = c[j][f] + 1, s += 2, c[d][f] = Math.min(l, j, s));
    ...
    var La = o.setInterval, Ma = o.clearInterval, Na = o.setTimeout, Oa = o.clearTimeout;
    ...
    function fb(a, b, c) {
        ...
        if (!a || !a.ownerDocument) return k;
        var d = a.ownerDocument.documentElement, e = 0, f = v(c) ? c + 1 : -1;
    ...
    function hb(a) {
        a = a || window.event;
        return !a ? k : fb(a.target || a.srcElement, gb, 10)
    }
    ...
    function kb(a) {
        ...
        jb() ? a() : o.document.addEventListener ? (o.document.addEventListener("DOMContentLoaded", b, m), o.addEventListener("load", b, m)) : (o.document.attachEvent("onreadystatechange", b), o.attachEvent("onload",
            b))
    };
    ...
    var E = {};
    E.D = function () {
        E.La ? E.wa("pageload") : (E.Db = [{target: o, event: "scroll"}, {
            target: document.body,
            event: "keydown"
        }, {target: document.body, event: "mousemove"}, {target: o, event: "resize"}, {
            target: document.body,
            event: "mousedown"
        }], E.Da = k, E.aa = k, E.Ka = {}, E.pb = {}, q(E.Db, function (a) {
            var b = a.event;
            ...
            E.wa("focus")
        }), E.wa("pageload"), z(document.body, "click", function (a) {
            (a = hb(a)) && C.Q("c", a)
    ...
    E.wa = function (a, b) {
        ...
        E.tc(a);
        if (E.Da === k) E.wb(a); else if (!E.aa || ha[E.aa] < ha[a]) E.aa = a
    };
    E.tc = function (a) {
        E.pb[a] = r()
    };
    ...
    var H = "path", I = "domain", Bb = "useCanonical", Cb = "useCanonicalDomain", J = "title", Db = "virtualReferrer",
        Ta = "cookieDomain";
    ...
    function Kb(a, b, c, d) {
        ...
        this.Ob = M.B() !== k || L.Lb(this.S, this.da);
        this.zb = m
    }
    ...
    n.q = function (a, b) {
        if (this.Oa) return "";
        var a = b ? a : this.za + a, c = (M.B() ? M : L).q(a);
        !c && M.B() && (c = L.q(a));
        if (c) {
            this.remove(a, b, "", h);
            var d = L.q(a), e = this.hb[Ta] && Ra, f = la(), e = e && f !== Qa();
            if (c === d && !e) return d;
    ...
    function Lb(a) {
        var b = k;
        if (a && (b = Mb(), b = !b ? b : N(b.pathname) + b.search + b.hash)) return b;
        var c = o.location, b = N(c.pathname), a = c.search || "", a = a.replace(/PHPSESSID=[^&]+/, ""),
            d = /&utm_[^=]+=[^&]+/ig;
        (c = d.exec(c.search)) && (a = a.replace(d, ""));
        d = /\?utm_[^=]+=[^&]+(.*)/i;
        (c = d.exec(a)) && (a = a.replace(d, c[1] != "" ? "?" + c[1] : ""));
        c = a;
        a = "fbclid,gclid,gbraid,wbraid,msclkid,lcid,_gl,_ga,pure360.trackingid".split(",");
        d = "";
        if (c.length > 1) {
            c[0] === "?" && (c = c.replace("?", ""));
            c[0] === "&" && (c = c.replace("&", ""));
            for (var c = c.split("&"),
                     e = 0; e < c.length; e++) {
                var f = c[e].split("=");
                f[0].length && a.indexOf(f[0].toLowerCase()) === -1 && (d += d.length ? "&" : "?", d += c[e])
            }
        }
        a = N(d);
        return b + a
    ...
    for (var Pb = {}, Qb = 0; Qb < 81; Qb++) Pb["0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-._~!$&'()*+,;=:@[]".charCodeAt(Qb)] = h;

    function Rb(a, b) {
        if (a === "%") return "%25";
        var c = parseInt(b, 16);
        return Pb[c] ? String.fromCharCode(c) : "%" + b.toUpperCase()
    }

    function N(a) {
        if (!A(a)) return a;
        a = a.replace(/%([0-9A-Fa-f]{2})?/g, Rb);
    ...
    function Q() {
        ...
        return o._cb_shared
    };var R = {Fb: {IDLE: 0, Ec: 1, xc: 2, Eb: 3}, J: 0};
    R.D = function () {
    ...
    n.D = function () {
        ...
        if (!a) {
            ...
            !d || e ? (d = p(Ub(this)), a[4] = d, f = 1, this.k.remove("_cb_svref", h)) : f += 1;
            a[5] = f;
            f = "1";
            e = a && +a[2];
            d = a && a[3];
            ...
            d = f;
            c || (c = this.a.utoken || p(Ub(this), 3), a[1] = b);
            a[2] = b;
            a[3] = d;
        ...
        c = +a[1];
        d = +a[2];
        if ((b = a[3]) && c && d) j = (Math.min((Math.abs((Da(d) - Da(c)) / 864E5) || 0) + 1, 16, b.length) - 1).toString(16), j += ("0000" + parseInt(b, 2).toString(16)).slice(-4);
        this.mb = j;
        this.dc = O("n", 1);
        this.na = a[0];
        this.oc = a[4];
        this.lc = a[5];
        this.mc = Xb(this);
        this.k.create("_cb_svref", Xb(this) || "null", 1800, h);
        this.F.D();
        R.D();
        E.D();
        ...
        this.Ua = h;
        if (this.Ra) Na(this.Ra, 0), this.Ra = k
    };
    n.Ea = function () {
    ...
    n.ia = function () {
        var a = this.F.ga, a = this.a.reading && +this.a.reading || a > 0;
        this.sa < this.X && !a ? this.sa++ : Ia() && !a ? this.sa++ : (a ? this.X = 0 : Zb(this), this.sa = 0, this.T.push(0), this.T.length > 18 && this.T.shift(), this.Xa && r() - this.la >= this.Ma ? this.terminate() : this.Z())
    };
    n.sb = function () {
        this.T.push(1);
        var a = 0;
        ...
        a < 3 ? (this.Va = h, Zb(this)) : (this.terminate(), this.k.create("_SUPERFLY_lockout", "1", 600))
    };
    n.ya = function () {
    };
    n.fc = function () {
    ...
    function Zb(a) {
        var b = a.X, b = b ? Math.min(b * 2, 16) : 1;
        a.X = b
    }
    ...
    function ac(a) {
        var b = a.a.referrerOverrideQueryParam, c = "";
    ...
    function Ub(a) {
        a = [U(a), eb("Width"), eb("Height")];
        return ka(a)
    }

    function cc(a) {
        var b = [], c = a.k.q("_chartbeat4");
    ...
    n.pa = function () {
        this.terminate();
        Aa("pagehide", this.Sa);
        this.Sa = this.xa = this.k = this.T = this.a = k;
        this.F.pa();
        this.F = k;
        S.M.pa.call(this)
    };
    ...
    function ec(a, b, c) {
        var d = a.offsetLeft, e = a.offsetTop, f = fc(a);
        d += f.x;
        e += f.y;
        for (var i = m, j = c ? 0 : Math.floor(cb("X", "Left", g)), l = c ? 0 : Math.floor(cb("Y", "Top", g)), f = a.offsetParent; a && a !== b && a !== document.body;) {
            if (a === f) f = fc(a), d += a.offsetLeft + f.x, e += a.offsetTop + f.y, f = a.offsetParent;
            c || (d -= a.scrollLeft, e -= a.scrollTop);
            if (gc(a, ["position"]).position === "fixed") {
                i = h;
                break
            }
            a = a.parentElement
        }
        c || (d -= b ? b.scrollLeft : j, e -= b ? b.scrollTop : l);
        i && (d += j, e += l);
        return {x: d, y: e}
    }
    ...
    function gc(a, b) {
        var c = {}, d, e;
        o.getComputedStyle ? d = o.getComputedStyle(a, k) : a.currentStyle ? e = "currentStyle" : a.style && (e = "style");
        q(b, function (b) {
    ...
    function fc(a) {
        var b = {x: 0, y: 0}, a = gc(a, ["transform"]).transform;
        if (!A(a)) return b;
        var c = a.match(hc);
        if (!c) return b;
        var a = c[2].split(", "), d;
    ...
    function ic() {
        var a = o.location.href, a = a.replace(/-{2,}/g, "-"), a = Za(a);
    ...
    function jc(a) {
        ...
        if (b.length === 1) c = b[0].split(","), d = 0; else {
            var e, f = ic(), i = $a(f);
            q(b, function (a, b) {
                var f = a.split(","), l = Ha(i, decodeURIComponent(f[0]));
        ...
        var a = [], b = decodeURIComponent(c[0]), f = decodeURIComponent(c[1]), j = c[2];
        c.splice(0, 3);
        for (var l = c.length / 3, s = 0; s < l; s++) {
            var w = s * 3 + 2;
            a.push({
                Fc: b,
                origin: f, N: j, $: w < c.length ? c[w] : "", Pb: c[s * 3], uc: c[s * 3 + 1]
            })
        }
        return a
    }
    ...
    function kc(a) {
        var b = a.topStorageDomain, a = a[I], c = o.location.hostname;
        return b ? b : lc(c, a) ? a : c.replace(/^www\./, "")
    }
    ...
    function nc(a) {
        ...
        if (b !== k) {
            ...
            b.s && q(b.s, function (a, b) {
                d[b] = typeof a === "string" ? {gb: a, $: ""} : {gb: a.chosenVariant, $: a.specificLocation}
            });
            c = {Ya: d, N: b.g, qb: b.m}
        }
        return {status: a.s, data: c, code: a.c, message: a.m}
    };

    function oc(a, b) {
        for (var c = b || document.documentElement, d = [], e = k, f = a, i, j, l, s, w, D; f && f !== c;) {
    ...
    n.D = function () {
        V.M.D.call(this);
        Fb(this.a);
        var a = !!this.a[Bb], b = Nb(!!this.a[Cb] && a);
//        K(this.a, "mabServer", "mabping.chartbeat.net");
        K(this.a, J, document.title);
        K(this.a, I, b);
        this.a[H] = this.a[H] ? N(this.a[H]) : Lb(a);
        this.fa = x(b);
        this.a[I] = x(this.a[I]);
        this.sc = kc(this.a);
        this.ea = this.ta = m;
        this.lb = [];
        var c = this, a = jc({domain: "." + this.sc, path: this.a.cookiePath || "/"});
        if (a !== k) this.ta = h, q(a, function (a) {
            c.lb.push(new mc(a.origin, a.Pb, a.uc, a.N, a.$))
        });
        this.rb = 0;
        this.Ca = k;
        dc(u(this.Zb, this))
    ...
    function pc(a) {
        var b = a.a;
        return Ea() + "//" + b.mabServer + "/ping/mab?h=" + encodeURIComponent(b[I]) + "&p=" + encodeURIComponent(b[H]) + "&d=" + encodeURIComponent(a.fa) + "&u=" + a.na + "&c=" + Math.round((r() - a.la) / 600) / 100 + "&V=139"
    }
    ...
    n.qc = function (a) {
        a = nc(a);
        this.ea ? qc(this, a) : this.Ca = a
    };

    function qc(a, b) {
        var c = pc(a), d = b.status, e = b.data;
        if (d == "s" && e !== k) {
            var f = u(a.Aa, a);
    ...
    ;var tc = "engagedSeconds",
        uc = {Cc: "id", Bc: tc, yc: "campaignId", zc: "creativeId", Dc: "placementId", Ac: "element"};
    var vc, wc, W;
    ...
    function yc() {
        ...
        W = g
    };var zc = /^https?:\/\/([^/]*\.)?chartbeat\.com\/publishing\/hud2\/launch\//;
    ...
    function Cc(a) {
        /[\/.]chartbeat\.com$/.test(a.origin) && String(a.data).indexOf("_cb_ip") == 0 && Bc() && (a.source.postMessage(1, a.origin), kb(Ac), Aa("message", Cc))
    };
    ...
    function Dc(a, b) {
        ...
        this.ub = Lb(m);
        this.ic = Nb(m);
        var c = ab("property", "meta", k, "og:url");
        this.ja = (this.Y = c && c.length ? Za(c[0].content) : k) ? N(this.Y.pathname) + this.Y.search + this.Y.hash : "";
        this.ec = this.Y ? this.Y.hostname : "";
        this.Ia = document.title || "";
        var d;
        if ((c = ab("property", "meta", k, "og:title")) && c.length) d = c[0].content;
        this.va = d;
        var e;
        if ((d = ab("property", "meta", k, "twitter:title")) && d.length) e = d[0].content;
        this.ma = e;
        e = !!this.Bb;
        d = this.Bb !== g;
        var c = !!this.Ab, f = this.Ab !== g, i = !!this.H, j;
        j = x(this.fb);
        var l = x(this.ic);
        j = j === l;
        var l = !!this.ja, s = !this.H ? m : this.oa === this.ja, w = this.oa === this.ub, D;
        D = this.oa;
        var F = wa(this.ub);
        D = D === F;
        var F = !!this.Ia, T = !!this.va, P = !!this.ma, y = this.Ia === this.va,
            t = !this.ma ? m : this.Ia === this.ma, Lc = !this.va || !this.ma ? m : this.va === this.ma, Mc = !!this.rc,
            Nc = !!this.O, Oc = this.O ? this.O.charAt(0) !== "/" : m,
            Pc = !this.H ? m : this.O === this.oa, Qc = !this.ja ? m : this.O === this.ja,
            Rc = !this.H ? m : this.ib === x(this.fb), Sc = !this.ja ? m : this.ib === x(this.ec), Tc = !!this.Cb,
            Uc = this.Cb ? m : !!this.wc, Vc = Ea() === "https:", Wc = !!XMLHttpRequest, Y;
        this.O ? (Y = xa(this.O), Y = Y !== wa(Y)) : Y = m;
        e = [e, d, c, f, i, j, l, s, w, D, F, T, P, y, t, Lc, Mc, Nc, Oc, Pc, Qc, Rc, Sc, Tc, Uc, Vc, Wc, Y];
        d = 1;
...
//        K(this.a, "pingServer", "ping.chartbeat.net");
    ...
    X.prototype.ya = function () {
        this.k.update("_chartbeat4", ["t=" + this.Wa, "E=" + this.F.ca, "x=" + $b(this), "c=" + Math.round((r() - this.la) / 600) / 100, "y=" + eb("Height"), "w=" + db("Height")].join("&"), 60, g, g, 1)
    };
    var Ya = "h,p,u,d,g,g0,g1,g3,g4,n,nc,f,c,x,m,y,o,w,j,R,W,I,E,e,v,r,vp,K,l1,KK,PA,b,A,_c,_m,_x,_y,_z,_s,t,V,z,i,L,tz,l,,sn,C,sv,sr,sd,im".split(",");
    n = X.prototype;
    n.Z = function (a) {
        this.ka++;
        var b = {};
        ...
        if (this.mb && !this.a.noCookies && this.k.isSupported()) b.f =
            this.mb;
        b[""] = Hb(this.a);
        b.t = this.Wa;
        b.V = 139;
        ...
        b.W = 0;
        b.I = 0;
        E.Ib() ? b.W = 1 : this.a.reading && +this.a.reading || c > 0 || b.c < 0.09 ? b.R = 1 : b.I = 1;
        b.e = c;
        c = Vb(this);
        if (this.Va) {
            this.Va = m;
        ...
        if (c) {
            if (this.U) {
                if (b.v =
                    encodeURIComponent(this.U.path), b.K = Fc(this.U), this.U.Pa > 1) b.l1 = this.U.Pa
            } else b.v = U(this);
            this.ua && (b.vp = 1)
        } else b.r = U(this);
        c = Pa(b.v);
        ...
        d = this.a;
        c = d.idSync;
        if (ja(d[I]).toString() !== [-2029634429, -1659526092, -2053164062, -1348054445, 1670716250].toString()) c =
            c ? Ga(c) : ""; else {
        ...
        b.l = c ? 1 : "";
        this.F.ga = 0;
        this.a.alias ? b.PA = encodeURIComponent(this.a.alias) : (a = Gc(o.location.href), b.PA = encodeURIComponent($a(a)));
        this.Aa(Ea() + "//" + this.a.pingServer + "/ping?" + Xa(b))
    };
    n.Yb = function (a) {
        var b = this.a, c = b.playerdomain || this.fa;
        if (na(a.origin) === na(c)) if (c = a.data, A(c) && c.indexOf("cbqpush::") === 0) a = c.split("::"), a.length == 3 && (a = a.slice(1), a[0].indexOf("_") === 0 && this.tb(a)); else if (c == "cbdata?") {
            var c = "&u=" + O("u"), d = "&t=" + O("t"), e = "&v=" + O("v"), f = "&r=" + O("r"),
                b = "domain=" + encodeURIComponent(b[I]) + "&uid=" + encodeURIComponent(b.uid) + "&path=" + encodeURIComponent(b[H]) + "&title=" + bc(this) + "&referrer=" + U(this) + "&internal=" + (Vb(this) ? "1" : "0") + "&subdomain=" + encodeURIComponent(this.fa) +
                    c + d + e + f + "&utoken=" + this.na;
    ...
    function Hc(a, b, c) {
        if (a.Xa && r() - a.la >= a.Ma) a.terminate(); else {
            ...
            if (d.protocol.indexOf("http") === 0) {
                var e = d.hostname !== o.location.hostname, d = $a(d), f = fb(b, function (a) {
                    return a.id
                }), i = oc(b, f), j = "";
                a.a.moduleAttribute && (j = (j = bb(b, a.a.moduleAttribute)) ? j.getAttribute(a.a.moduleAttribute) : "", j = j.replace(/::/g, "-").substr(0, 40));
                f ? (i && (i = "/" + i), i = "*[@id='" + f.id + "']" + i, f = oc(b)) : f = i;
                i = p(i);
                f = p(f);
                b = ec(b, g, h);
                c = {
                    left: b.x, top: b.y, path: a.a[H], href: d, cb: i, Fa: f, bb: "", Za: c, Pa: 0, Tb: a.a[I],
                    Na: j
                };
                a.Z(c);
                e || a.k.update("_chartbeat5", Ic(c), 60, m, g, 3, function (a) {
                    a = a.split("|");
                    return a[2] + "|" + a[3]
                })
            }
    ...
    function Ic(a) {
        var b = encodeURIComponent(a.bb), b = b.replace(/-/g, "%2D");
        b.length > 512 && (b = "");
    ...
    function Ec(a) {
        ...
        if (!b) return k;
        var c = b.split("::"), b = c.length, d, e = k, f, i = Gc(o.location.href), j = $a(i);
        q(c, function (a, b) {
            var c = a.split("|"), i = decodeURIComponent(c[3]);
            if (i) {
                i = za(j, i);
                if (i === 0) return d = c, e = b, m; else if (i === k) return h;
    ...
    if (!L.q("cb_optout") && !o.pSUPERFLY) {
        var Kc = new X, Z = {};
        o.pSUPERFLY = Z;
        var Xc = o.pSUPERFLY_mab, $ = o.pSUPERFLY_pub, Yc = [];
        Xc && Yc.push(Xc);
        if ($) Yc.push($), $.addEngagedAdFilter && (Z.addEngagedAdFilter = $.addEngagedAdFilter), $.refreshAd && (Z.refreshAd = $.refreshAd), $.registerGptSlot && (Z.registerGptSlot = $.registerGptSlot), Eb("_cba", function (a) {
            a()
        });
        Z.virtualPage = Jc(function () {
            Kc.qa();
            q(Yc, function (a) {
                a.evps()
            })
        ...
        Z.activity = u(Kc.Gb, Kc);
        Kc.Ea();
        zc.exec(document.referrer) &&
        Bc();
        var Zc = M.B(h);
        if (!Zc ? 0 : Zc.getItem("_cb_ip")) {
            var $c = o.location;
            (!/^(.+[.])?chartbeat\.com$/.test($c.hostname) ? 0 : /^\/publishing\/(overlay|hud|mab)\//.test($c.pathname)) || kb(Ac)
        } else z(o, "message", Cc)
    }
    ;
})();
